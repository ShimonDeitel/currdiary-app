...
final class CurrencyDiaryUITests: XCTestCase {
    ...
    func testAddEntryFlow() {
        ...
        let field1 = app.textFields["field_fromCurrency"]
    ...
    func testFreeLimitTriggersPaywall() {
        ...
        XCTAssertTrue(app.buttons["paywallPurchaseButton"].waitForExistence(timeout: 2) || app.staticTexts["Currency Diary Pro"].waitForExistence(timeout: 2))
    }
